...
# Default DB name for this app
	define('DB_NAME', "monkeyb1_p2_monkeybusiness_us"); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'nMb1#F-1)sgsLQs_#0CZ83t!LsA7RMLWDer41Q(p');
	define('TOKEN_SALT', '5kEDLN-1xV-*0*kN^MU0IGFqxf8yDG8q2cm-C&us');